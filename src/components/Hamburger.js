...
const Hamburger = ({ setOpen, open }) => (
  <motion.button
    ...
    className="group relative appearance-none flex items-center p-6 lg:p-8 -m-4 mr-0 border-l border-neutral-900/10 dark:border-white/30 font-sans text-sm uppercase tracking-widest no-underline mx-4 text-black dark:text-white"
  >
    Menu
